// =============================================================================
// HEALTHSHIELD - EMAIL MARKETING AUTOMATION
...
export const emailTemplates: Record<string, EmailTemplate> = {
  'booking-confirmation': {
    ...
    variables: ['customerName', 'date', 'timeSlot', 'serviceName', 'partySize', 'agentName', 'totalPrice', 'confirmationCode', 'meetingPoint'],
    htmlContent: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin:0;padding:0;background:#fff7ed;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="text-align:center;margin-bottom:30px;">
      <img src="https://healthshield-frontend.web.app/images/logo/healthshield-logo.png" alt="HealthShield" style="width:100px;height:auto;">
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);margin-bottom:30px;">
      ...
      <p style="color:#083344;font-size:16px;line-height:1.6;margin:0;">Thank you for choosing HealthShield for your health insurance needs. We're excited to have you as part of our community!</p>
    </div>
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);margin-bottom:30px;">
      ...
      <table style="width:100%;border-collapse:collapse;">
        ...
        <tr>
          ...
          <td style="padding:12px 0;color:#083344;font-weight:bold;">{{serviceName}}</td>
        </tr>
        <tr>
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);margin-bottom:30px;">
      ...
      <p style="color:#64748b;line-height:1.6;margin:0;">Each plan includes a welcome packet, and Please review your coverage details.</p>
    </div>
...
Howdy! 👋
Thank you for choosing HealthShield for your health insurance needs. We're excited to have you as part of our community!
...
<body style="margin:0;padding:0;background:#fff7ed;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    <div style="text-align:center;margin-bottom:30px;">
      <img src="https://healthshield-frontend.web.app/images/logo/healthshield-logo.png" alt="HealthShield" style="width:80px;">
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
      <p style="color:#083344;font-size:16px;line-height:1.8;">
        Thanks for joining the HealthShield family! We're your AI-powered health insurance partner, here to make coverage simple and accessible.
      </p>
      ...
      <ul style="color:#64748b;line-height:2.2;padding-left:20px;">
        <li><strong style="color:#083344;">Flexible Plans</strong> - Bronze, Silver, Gold, and Platinum tiers</li>
        <li><strong style="color:#083344;">AI-Powered Support</strong> - 24/7 assistance when you need it</li>
        <li><strong style="color:#083344;">Wellness Programs</strong> - Earn rewards for healthy habits</li>
        <li><strong style="color:#083344;">Telehealth Access</strong> - See a doctor anytime, anywhere</li>
      </ul>

      <div style="text-align:center;margin:30px 0;">
        <a href="https://healthshield-frontend.web.app/plans" style="display:inline-block;background:linear-gradient(135deg,#3b82f6,#06b6d4);color:white;padding:15px 40px;border-radius:50px;text-decoration:none;font-weight:bold;">Explore Our Plans</a>
      </div>
...
We're your AI-powered health insurance partner.

What we offer:
- Flexible Plans (Bronze, Silver, Gold, Platinum)
...
Explore our plans: https://healthshield-frontend.web.app/plans
...
- The HealthShield Team
  ...
  'abandoned-booking': {
    ...
    subject: '🏥 Your plan is waiting! Complete your enrollment',
    category: 'triggered',
    variables: ['customerName', 'serviceName', 'date', 'discountCode'],
    htmlContent: `
<!DOCTYPE html>
<html>
<body style="margin:0;padding:0;background:#fff7ed;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
      ...
      <p style="color:#083344;font-size:16px;line-height:1.8;">
        We noticed you were checking out <strong>{{serviceName}}</strong> for {{date}}. Great choice! 🎉
      </p>
...
We noticed you were checking out {{serviceName}} for {{date}}. Great choice!
...
- HealthShield
  ...
  'review-request': {
    ...
    category: 'transactional',
    variables: ['customerName', 'firstName', 'serviceName', 'agentName', 'reviewLink', 'discountCode'],
    htmlContent: `
<!DOCTYPE html>
<html>
<body style="margin:0;padding:0;background:#fff7ed;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:40px 20px;">
    <div style="text-align:center;margin-bottom:30px;">
      <img src="https://healthshield-frontend.web.app/images/logo/healthshield-logo.png" alt="HealthShield" style="width:80px;">
      <h1 style="color:#ea580c;margin:20px 0;">Thanks for Choosing HealthShield! 🏥</h1>
    </div>
    ...
    <div style="background:white;border-radius:20px;padding:30px;box-shadow:0 10px 40px rgba(0,0,0,0.08);">
      ...
      <p style="color:#083344;font-size:16px;line-height:1.8;">
        We hope you had an amazing time on {{serviceName}} with Agent {{agentName}}!
      </p>
      ...
      <div style="background:#fef7ed;border-radius:15px;padding:20px;margin-top:30px;text-align:center;">
        <p style="color:#083344;margin:0 0 10px;font-weight:bold;">Thanks for reviewing! Here's $25 off your next renewal:</p>
...
As a thank you, here's $25 off your next renewal: {{discountCode}}
...
- HealthShield
  ...
  'monthly-newsletter': {
    ...
    subject: '🏥 {{monthName}} HealthShield Update - News & Benefits!',
    category: 'newsletter',
    variables: ['firstName', 'monthName', 'featuredPlan', 'promoCode', 'upcomingEvents'],
    htmlContent: `
<!DOCTYPE html>
<html>
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;">
  ...
  <div style="padding:24px;">
    ...
    <p style="font-size:14px;color:#475569;line-height:1.6;">Here is what is happening at HealthShield this month!</p>

    <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:8px;padding:16px;margin:20px 0;">
      <h3 style="color:#92400e;margin:0 0 8px;">Featured Plan: {{featuredPlan}}</h3>
      <p style="font-size:14px;color:#78350f;margin:0;">Enroll this month and get exclusive benefits. Perfect for individuals and families!</p>
    </div>
    ...
    <div style="text-align:center;margin:24px 0;">
      <a href="https://healthshield.ai/plans" style="background:#3b82f6;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:bold;font-size:16px;display:inline-block;">Browse Our Plans</a>
    </div>
...
export async function sendEmail(
  ...
  const email: Email = {
    ...
    to,
    toName,
    from: config?.fromEmail || 'hello@healthshield.com',
