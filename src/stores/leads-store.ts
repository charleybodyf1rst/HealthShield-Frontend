...
export const useLeadsStore = create<LeadsStore>((set, get) => ({
  ...
  fetchLeads: async (filters?: LeadFilters, page = 1, limit = 1500) => {
  ...
  fetchPipeline: async () => {
    ...
    try {
      ...
      const stageDefs = [
        ...
        { id: 'contacted_3', name: 'Contacted (3rd)', color: '#B45309', order: 3, probability: 20 },
        { id: 'contacted_5', name: 'Contacted (5th)', color: '#92400E', order: 4, probability: 25 },
        { id: 'contacted_6', name: 'Contacted (6th)', color: '#78350F', order: 5, probability: 30 },
        { id: 'pending', name: 'Pending', color: '#A855F7', order: 6, probability: 20 },
        { id: 'demo', name: 'Demo', color: '#0EA5E9', order: 7, probability: 50 },
        { id: 'census_requested', name: 'Census Requested', color: '#F97316', order: 8, probability: 35 },
        { id: 'proposal_sent', name: 'Proposal Sent', color: '#8B5CF6', order: 9, probability: 40 },
        { id: 'group_info', name: 'Group Info Submitted', color: '#6366F1', order: 10, probability: 55 },
        { id: 'agreement_signed', name: 'Agreement Signed', color: '#EC4899', order: 11, probability: 70 },
        { id: 'implementation', name: 'Implementation Call', color: '#14B8A6', order: 12, probability: 80 },
        { id: 'census_final', name: 'Census Finalized', color: '#06B6D4', order: 13, probability: 90 },
