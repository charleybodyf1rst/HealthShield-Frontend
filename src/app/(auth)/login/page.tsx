...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Set auth-token cookie so Next.js middleware allows /dashboard access
      const state = JSON.parse(localStorage.getItem('healthshield-crm-auth') || '{}');
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2 text-center lg:text-left">
        ...
        <p className="text-muted-foreground">
          Sign in to your HealthShield dashboard
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="mailto:support@healthshield.ai?subject=Password Reset Request"
