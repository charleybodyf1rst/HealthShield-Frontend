...
ARG NEXT_PUBLIC_HEALTHSHIELD_ORG_ID=12
ARG NEXT_PUBLIC_GOOGLE_MAPS_API_KEY=""
ARG NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID="DEMO_MAP_ID"
ARG NEXT_PUBLIC_PDF_RENDERER_URL=""
ARG NEXT_PUBLIC_PDF_RENDERER_TOKEN=""
...
ENV NEXT_PUBLIC_HEALTHSHIELD_ORG_ID=${NEXT_PUBLIC_HEALTHSHIELD_ORG_ID}
ENV NEXT_PUBLIC_GOOGLE_MAPS_API_KEY=${NEXT_PUBLIC_GOOGLE_MAPS_API_KEY}
ENV NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID=${NEXT_PUBLIC_GOOGLE_MAPS_MAP_ID}
ENV NEXT_PUBLIC_PDF_RENDERER_URL=${NEXT_PUBLIC_PDF_RENDERER_URL}
ENV NEXT_PUBLIC_PDF_RENDERER_TOKEN=${NEXT_PUBLIC_PDF_RENDERER_TOKEN}
